...
def parse_args():
    parser = argparse.ArgumentParser(description="Unified training entrypoint for MIGO.")
...
def main():
    ...
    run_task(args.task, "train", config_path=args.config, resolution=args.resolution, overrides=overrides)
